          ...
          <div className="feed col-span-2 border-x-2 border-t-slate-800 px-6 overflow-y-auto h-screen pt-[70px]">
            ...
            <div className="profile-tabs border-b border-gray-300">
              ...
              <div className="flex justify-around text-sm font-medium text-gray-500">
                <button
                  className={`px-4 py-2 ${activeTab === 'posts' ? 'text-blue-500 border-b-2 border-blue-500' : ''}`}
                  onClick={() => setActiveTab('posts')}
                >
                  Posts
                </button>
                <button
                  className={`px-4 py-2 ${activeTab === 'media' ? 'text-blue-500 border-b-2 border-blue-500' : ''}`}
                  onClick={() => setActiveTab('media')}
                >
                  Media
                </button>
                <button
                  className={`px-4 py-2 ${activeTab === 'likes' ? 'text-blue-500 border-b-2 border-blue-500' : ''}`}
